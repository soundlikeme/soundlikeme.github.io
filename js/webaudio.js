 ...
 *
 * ```javascript
 * var adapter = WaveformData.adapters.arraybuffer;
 ...
 *   adapter.fromAudioObject(progressEvent.target.response, onProcessed(waveform){
 ...
 * @constructor
 */
WaveformData.adapters.arraybuffer.fromAudioObject = function fromAudioObjectBuilder(raw_response, callback){
